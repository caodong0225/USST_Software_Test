...
class MainLoginPage(BasePage):
    ...
    user_id = "http://localhost/user/"
    go_chat = '//button[@class="dzq-button _3dGXPdGhdCm1EloEa162Hd dzq-button--medium"]'
    ...
    def operate_user(self, id):
        url = self.user_id + str(id)
        self.navigate_to(url)
    ...
    def send_message(self, id):
        ...
        self.navigate_to(url)
        assert self.is_not_found()
        self.click_element(self.go_chat)
